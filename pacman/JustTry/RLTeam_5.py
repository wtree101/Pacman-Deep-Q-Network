...
class RLagent(DefensiveReflexAgent):
    def __init__(self,index,numTraining=0): #再写了一个重构函数
       ...
       # print('RL',self.numTraining)
        ...
        self.maxTunnel = 0
        self.weights = util.Counter({'eat_food': 0.6590300364244062, 'distanceToFood': -8.779600420906856, 'check_died': -2.837174237536707, 'divides_attract': -1.9842137302372078, 'Capsule_attract': -0.13371181157406375, 'stop': -0.018288379604061954, 'Capsule_eaten': -0.056023821118565506, 'CornerAvoid': -0.7028755357403207, 'bias': 0.33971477319061183, 'defendersAvoid': -1.951560839168015})
