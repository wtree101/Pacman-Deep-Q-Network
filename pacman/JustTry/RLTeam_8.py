...
class RLagent(DefensiveReflexAgent):
    def __init__(self,index,numTraining=0): #再写了一个重构函数
       ...
       # print('RL',self.numTraining)
        ...
        self.maxTunnel = 0
        self.weights = util.Counter({'eat_food': 0.7154169911326704, 'distanceToFood': -20.164562149268328, 'check_died': -1.5342341003490534, 'divides_attract': -16.78125589911355, 'Capsule_attract': -0.08753886858795097, 'stop': -5, 'CornerAvoid': -1.6084622281378613, 'bias': 0.9046987151780473, 'defendersAvoid': -1.0438429748476368})
