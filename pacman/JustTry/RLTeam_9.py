...
class RLagent(DefensiveReflexAgent):
    def __init__(self,index,numTraining=0): #再写了一个重构函数
       ...
       # print('RL',self.numTraining)
        ...
        self.maxTunnel = 0
        self.weights = util.Counter({'eat_food': 0.6357503244883377, 'distanceToFood': -39.661977406885725, 'check_died': -3.2475463615720748, 'divides_attract': -30.60072657191291, 'Capsule_attract': -3.579843997110553, 'stop': -5, 'CornerAvoid': 0.5620928211495898, 'bias': 1.5335145607807743, 'defendersAvoid': -0.06837170899819639})
